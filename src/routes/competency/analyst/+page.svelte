...
<script>
    ...
    const tagline = `Your 3-o'clock is ready for you.`;
    const description = `
    ...
    const requisitionName = 'Magic <three>3</three> Ball';
    const requisitionDesc = `
      This red orb has a small window into an inky black void,
      teeming with fateful possibilities. Once per mission,
      you can describe a decision you have to make and list
      three options you're considering. Shake the ball and it will
      randomly select one of the options. That option will
      be the best one and lead to a favorable outcome for you;
      choosing any other option will result in disaster.
    `;
