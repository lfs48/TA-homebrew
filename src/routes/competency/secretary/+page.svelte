...
<script>
    ...
    const requisitionName = 'RSVP Envelope';
    const requisitionDesc = `
      This red envelope contains a single subtly off-white,
      tastefully thick invitation card.
      Once per mission you may write someone's name on the card,
      along with a meeting place and time at least 30 minutes in the future.
      After returning the card to the envelope and placing it in any mailbox,
      the invited party is guaranteed to be at the chosen place at the chosen time.
    `;
