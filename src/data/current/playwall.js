export default {
    ...
    T1: {
        ...
        desc:`
            <p>
            Identify a numerical quantity that pertains to you, a target, or
            a piece of game text within <red>Triangle Agency</red>.
            Raise your arm and point toward the heavens. Roll <b>Persistence</b>.
            </p>
        `,
        success:`
            <p>
                <blue>On a success,</blue> you increase that quantity by an amount equal to
                the number of <red>3s</red> rolled. The change persists for the rest of the mission.
            </p>
        `,
        additional:`
            <blue>For each additional <red>3</red>,</blue>
        `,
        tri:`
            <red>On Triscendence,</red> the change is permanent.
        `,
        failure:`
